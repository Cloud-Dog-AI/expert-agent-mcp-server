...
# Track B gate runner: MariaDB + OpenRouter/qwen3-14b (OpenAI-compatible).
# Expects a fully configured env file under private/ (plus matching -secrets).

ENV_FILE="${1:-private/env-test-mariadb-openrouter}"
...
files=(
  ...
  tests/integration/IT2.3_MCPToolIntegration/test_mcp_tool_integration.py
)
