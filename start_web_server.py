#!/usr/bin/env python3
"""
Expert Agent MCP Server - Web UI Server
"""
...
from src.servers.web.server import WebServer
...
if __name__ == "__main__":
    logger = setup_logging(level="INFO", format_type="json", pii_redaction=True, server_name="web")
    server = WebServer()
    try:
